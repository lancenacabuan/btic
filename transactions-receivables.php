...
$_SESSION['HTTP_REFERER']='transactions-receivables.php';
$colwidth=array();
$thname=array();
$colname=array();
$component=NULL;
$title=' - Accounts Receivable';
$tab=array('transactions-receivables.php'=>'Receivables');
html_start($title,$tab);

$form='Accounts Receivable Form';
$new='transactions-receivables.php';
form_start($form,$new);
...
<div class="panel-body">
    ...
    if($total>500)
    {
        $_SESSION['tblname']='optimize_receivables';
        $json_array=array();
        while($row=mysql_fetch_assoc($content))
        { $json_array[]=$row; }
        $json_data=json_encode($json_array);
        file_put_contents('data/transaction-receivables.json','{"data":'.$json_data.'}');
        ?>
    ...
    { $_SESSION['tblname']='tblReceivables'; }
    ?>
